...
public class DrawIfAttribute : PropertyAttribute
{
    ...
    public bool drawIfNot { get; private set; }
    ...
    public DrawIfAttribute(string comparedPropertyName, object comparedValue, bool drawIfNot = false, DisablingType disablingType = DisablingType.DontDraw)
    {
        this.comparedPropertyName = comparedPropertyName;
        this.comparedValue = comparedValue;
        this.disablingType = disablingType;
        this.drawIfNot = drawIfNot;
    }
}